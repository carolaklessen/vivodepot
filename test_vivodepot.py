...
def main():
    ...
    check("Export: generateStammdaten() vorhanden",   "function generateStammdaten" in html)
    check("Export: Stammdaten-Karte im UI",            "Meine Stammdaten" in html)
    check("Export: Stammdaten onclick-Aufruf",         "generateStammdaten()" in html)
    check("Export: Stammdaten enthält Steuer-ID",      "function generateStammdaten" in html and "steuer_id" in html)
    check("Export: Stammdaten enthält IBAN",           "function generateStammdaten" in html and "konto_iban" in html)
    check("Export: Stammdaten enthält RV-Nummer",      "function generateStammdaten" in html and "rv_nummer" in html)
    check("Export: Stammdaten enthält Krankenversicherung", "function generateStammdaten" in html and "kv_nummer" in html)
    check("Export: Stammdaten PDF-Dateiname",          "Vivodepot_Stammdaten_" in html)
    check("Text: Behörden-Infobox nennt hochladen",   "Online-Portal des Amtes hochladen" in html)
    check("Text: Szenario-PDF nennt hochladen",        "Hochladen auf Online-Portale" in html)
    check("Text: QR-Code-Hinweis nennt hochladen",    "Foto des QR-Codes hochladen" in html)
