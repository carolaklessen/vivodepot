...
def main():
    ...
    check("Store: _ls Wrapper", "_ls" in html and "localStorage" in html)
    check("Store: _ls.get()", "_ls.get(" in html)
    check("Store: _ls.set()", "_ls.set(" in html)
    ...
    check("Browser: localStorage try/catch (_ls)", "_ls" in html and "localStorage" in html and "try" in html)
    ...
    check("Robust: _ls Wrapper try/catch", "_ls" in html and "try" in html and "localStorage" in html)
